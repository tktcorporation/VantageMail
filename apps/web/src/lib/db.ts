...
// --- Legacy async 関数（後方互換） ---
// 既存の呼び出し元（routes/oauth/callback.tsx, routes/api/accounts/index.ts 等）が
// (db, ...) シグネチャで呼んでいるため、Task 5 で Effect 化するまで維持する。
// Effect 化完了後に削除可能。

/** @deprecated Effect 版の findUserByGoogleSub を使うこと */
export async function findUserByGoogleSubLegacy(
  db: D1Database,
  googleSub: string,
...
/** @deprecated Effect 版の createUser を使うこと */
...
/** @deprecated Effect 版の updateUserProfile を使うこと */
...
/** @deprecated Effect 版の findLinkedAccountsByUserId を使うこと */
export async function findLinkedAccountsByUserIdLegacy(
  db: D1Database,
  userId: string,
...
/** @deprecated Effect 版の findLinkedAccountByEmail を使うこと */
export async function findLinkedAccountByEmailLegacy(
  db: D1Database,
  userId: string,
  email: string,
...
/** @deprecated Effect 版の createLinkedAccount を使うこと */
export async function createLinkedAccountLegacy(
  db: D1Database,
  account: Omit<LinkedAccountRow, "created_at" | "updated_at">,
): Promise<void> {
  const now = Date.now();
...
/** @deprecated Effect 版の updateLinkedAccountToken を使うこと */
export async function updateLinkedAccountTokenLegacy(
  db: D1Database,
  accountId: string,
...
/** @deprecated Effect 版の updateLinkedAccountProfile を使うこと */
export async function updateLinkedAccountProfileLegacy(
  db: D1Database,
  accountId: string,
  profile: { display_name: string; avatar_url: string | null },
  userId?: string,
...
/** @deprecated Effect 版の deleteLinkedAccount を使うこと */
export async function deleteLinkedAccountLegacy(
  db: D1Database,
  userId: string,
  accountId: string,
): Promise<boolean> {
...
/** @deprecated Effect 版の deleteUser を使うこと */
export async function deleteUserLegacy(db: D1Database, userId: string): Promise<void> {
  // linked_accounts は ON DELETE CASCADE で自動削除される
